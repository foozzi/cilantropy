...
def about():
    ...
    data['version'] = cilantropy.__version__
    data['author'] = cilantropy.__author__
    data['author_url'] = cilantropy.__author_url__
...
def run_main():
    ...
    print('Cilantropy %s - Python Package Manager' % (cilantropy.__version__,))
    print('By %s 2020\n' % (cilantropy.__author__,))
    parser = OptionParser()
